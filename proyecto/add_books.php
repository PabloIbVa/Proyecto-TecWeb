            ...
            <div class="card-body">
              ...
              <form id="book-form">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" id="name" placeholder="Coloca el nombre" required>
                </div>
                <div class="form-group">
                  <fieldset>
                    <label for="familia">Link:</label>
                    <input type="text" id="link" name="link" class="form-control" required>
          
                    <label for="form-image">Imagen:</label> 
                    <input type="text" id="imagen" name="imagen" class="form-control" required value="Backend/img/libros/default.png">
                  </fieldset>
                </div>
